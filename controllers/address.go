...
func (this *AddressController) Address_List() {
	o := orm.NewOrm()
	addresstable := new(models.XssAddress)
	var addresses []models.XssAddress
...
func (this *AddressController) Address_Save() {
	...
	var addressinfo models.XssAddress
